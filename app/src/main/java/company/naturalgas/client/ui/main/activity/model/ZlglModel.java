...
public class ZlglModel extends BaseMvp_PVModel
{
    public static final int GetZlglDatas = 0x0001;
    ...
    public void executeOfNet(Context context, int netRequestCode, BaseMvp_LocalObjCallBack localCallBack)
    {
        ...
        {
            case GetZlglDatas: NetClient.getInstance(context).getNetUrl().getZlglDatas(getMultipartForms()).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new BaseMvp_NetObjCallBack(context,localCallBack));break;
        }
    }
